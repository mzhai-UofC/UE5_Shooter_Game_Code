...
// Note: if the bullet does not shot at the center of the cross hair, set the CrosshairLocation.Y -= 50.0f 
// 
// Sets default values
...
void AShooterCharacter::FireWeapon()
{
	if (FireSound)
	{
		//add voice effect when shooting
...
// if the fire button is long pressed, contineous shooting until unpressed 
...
//Drop the current weapon when player selected a new weapon
...
//Increment the item num when picked up
...
//change the camera path when swap the weapon
...
//Swap the weapon when player point to the weapon and the distance smaller than the radius
